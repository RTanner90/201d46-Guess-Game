...
one ();
function two(){favorite_videogame + 't or f';
...
function three(){console.log(favorite_genre_of_music + 't or f');
...
three();
function four(){console.log(preference_between_cats_and_dogs + 't or f');
...
four();
function five(){console.log(best_final_fantasy + 'Y or N');
...
six();
function seven(){console.log('user refuses to answer the question');
